package com.kve.dubbo_provider_course.service.Impl;
...
import com.kve.dubbo_interface.dao.*;
import com.kve.dubbo_interface.model.*;
import com.kve.dubbo_interface.service.CourseSelectionService;
import com.kve.dubbo_interface.service.ExamService;
import com.kve.dubbo_interface.service.HomePageService;
...
public class CourseSelectionServiceImpl implements CourseSelectionService {
    ...
    public ArrayList<Map> getUnChooesCoId_TeaId(List<StuCo> stuCos, String major_id) {
        List<String> allCourse_id = getAllCourse_id(major_id);  //在course表里获取专业major_id对应的全部课程co_id
        for (StuCo stuCo : stuCos) {
